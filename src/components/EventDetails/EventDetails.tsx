...
const EventDetails: React.FC<EventDetailsProps> = ({ event_data }) => {
  ...
  return (
    <section data-testid="event-details-section" className="max-w-4xl sm:p-6 p-3 space-y-6">
      <Card>

        <CardHeader>
          <CardTitle className=" text-xl sm:text-3xl font-bold">{event_data?.name}</CardTitle>
        </CardHeader>
